			...
			<body>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<div id="description">
							...
							<p>
								...
								<a href="https://www.monfansubvn.com" target="_blank">Mon Fansub</a>
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://www.monfansubvn.com/sitemap.xml">&#8592; Sitemap Index</a>
							</p>
					...
					<xsl:otherwise>
						...
						<div id="content">
							<xsl:if test="count(sitemap:sitemwwwndex/sitemap:sitemap) &gt; 0">
								<p>
									This XML Sitemap Index file contains
									<strong>
										<xsl:value-of select="count(sitemap:sitemwwwndex/sitemap:sitemap)" />
									</strong>
									sitemaps.
								</p>
								<table id="sitemap" cellpadding="3">
									...
									<tbody>
										<xsl:for-each select="sitemap:sitemwwwndex/sitemap:sitemap">
							...
							<xsl:if test="count(sitemap:sitemwwwndex/sitemap:sitemap) &lt; 1">
								<p>
